...
<template>
    <div class="switch" :class="{active: theme ==='dark'}" @click="theme = theme === 'dark' ? 'light' : 'dark'"></div>
</template>
...
.switch {
    ...
    &::after {
        ...
        box-shadow: 10px 60px 0 10px #fff, 65px 60px 0 5px #fff,
            95px 70px 0 10px #fff, 135px 45px 0 5px #fff, 170px 35px 0 10px #fff,
            195px -5px 0 10px #fff, -10px 0 0 50px rgba(255, 255, 255, 0.2),
...
.switch.active {
    ...
    &::after {
        ...
        box-shadow: 10px 60px 0 10px transparent, 65px 60px 0 5px transparent,
            ...
            10px 40px 0 10px transparent, 70px 35px 0 10px transparent,
            95px 40px 0 10px transparent, 135px 20px 0 10px transparent,
            155px 15px 0 10px transparent, 190px -20px 0 10px transparent;
    }
}
</style>
